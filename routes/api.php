...
Route::get('/shared/check-facture-exists', [SharedController::class, 'checkFacture']);
Route::get('/shared/check-devis-exists/{num}', [SharedController::class, 'checkDevis']);
Route::get('/shared/check-bl-exists', [SharedController::class, 'checkBl']);
